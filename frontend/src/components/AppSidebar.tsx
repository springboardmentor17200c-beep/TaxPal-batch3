                  ...
                  <SidebarMenuButton asChild>
                    <NavLink
                      ...
                      // activeClassName="bg-sidebar-accent text-sidebar-accent-foreground font-medium"
                        className="flex items-center gap-4 rounded-xl px-4 py-3 text-base font-medium text-sidebar-foreground transition-all duration-200 hover:bg-primary/10 hover:text-primary"
                        activeClassName="bg-primary text-white shadow-md font-semibold"
                    >
